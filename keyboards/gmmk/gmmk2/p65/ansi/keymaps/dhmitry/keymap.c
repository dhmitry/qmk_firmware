...
[_HM] = LAYOUT_65_ansi_blocker(
  ...
  KC_NO,    HOME_A,   HOME_S,   HOME_D,   HOME_F,   KC_G,     KC_H,     HOME_J,   HOME_K,   HOME_L,   HOME_SCLN,KC_QUOT,  KC_ENT,             KC_NO,
  KC_NO,    KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_NO,              KC_UP,    KC_END,
  KC_NO,    KC_NO,    KC_NO,                                  KC_SPC,                                 KC_NO,    MO(_FL),  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
